...
\clearpage
\addcontentsline{toc}{chapter}{EEPPI-Usermanual}
\label{chapter:userManual}
\includepdf[pages=-, pagecommand={}]{tutorial/media/EEPPI-Usermanual.pdf}
\addcontentsline{toc}{section}{Processor Beispieldaten}
