\chapter{Ergebnisse}
	...
	\section{Zusätzliche Features}
		...
		\subsection{Im- und Export der Daten von \eeppi}
			...
			Dies ermöglicht das Transferieren von Tasktemplates und Mappings zu einer andern \eeppi -Instanz.
	...
	\section{Erweiterungs-Möglichkeiten}
		...
		\subsection{Ersatz der Serverapplikation}
			...
			Parameter wie z.B. Ressourcenadressen lassen sich auf dem Client konfigurieren. 
