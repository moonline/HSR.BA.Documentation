\chapter{Ergebnisse}
	...
	\section{Umsetzung der Userstories}
		Im Rahmen der Konzeptphasen wurden einige Userstories definiert, unterteilt in Core- und Advanced-Userstories.
	...
	\section{offene Punkte, Bugs/technische Probleme}
		Aufgefundene Bugs wurde während der Stabilization-Phase nach dem Feature-Freeze noch gefixt. Nach dem Code-Freeze aufgefundene Bugs sind folgend aufgelistet.
		...
		\begin{description}
			...
			Der existierenden Benutzer wird jedoch nicht überschrieben oder verändert.
		\end{description}
