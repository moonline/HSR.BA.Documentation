\chapter{Userinterface}
	\section{UI-Mocking}
		...
		dass aus \tt s Tasks generiert werden, 
	...
	\section{Finales Userinterface}
		...
		Dies war insbesondere in der Darstellung der Problems \& \tt s notwendig, 
		...
		\begin{figure}[H]
			...
			\caption{Problems \& \tt s}
			\label{fig:eeppiDecisionsAndTaskTemplates}
		\end{figure}	
		
		Die Ansicht der verfügbaren Problems, der \tt s und deren Mapping wurde nach dem Mockup umgesetzt und anschliessend noch um viele zusätzliche Informationen erweitert (Abbildung~\ref{fig:eeppiDecisionsAndTaskTemplates}).
