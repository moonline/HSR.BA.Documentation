	\section{Entwurf \& Begründungen}
		...
		\subsection{Tasktransmission Workflow}
			...
			Processors stellen kleine Funktionalitäten dar, die Daten umwandeln, wie z.B. "`Date processors"', die Kalenderdaten umwandeln, "`Issue type processors"', die Issuetypen konvertieren, "`User processors"', die Relationen zu Benutzern so umwandeln, das das \ppt\ den User korrekt verknüpfen kann oder "`Conditional processors"' und "`Option processors"', die Bedingungen verarbeiten.
