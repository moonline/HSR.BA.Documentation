\chapter{Architektur}
	...
	\section{Erweiterung CDAR}
		...
		\decision{
			...
			{
				\eeppi\ soll die \cdar\ API benutzen und den Login-Mechanismus. \eeppi besitzt allerdings eine eigene Server- sowie UI-Komponente und eine eigene Persistenz. 
				\begin{description}
					\item[Vorteile] \
						\begin{itemize}
							...
							\item Es sind keine Anpassungen an \cdar\ notwendig, weder an der Persistence, der Serverkomponente noch am UI.
