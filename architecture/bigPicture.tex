\chapter{Architektur}
	...
	\section{Anbindung der externen Systeme}
		...
		\subsection{Anbindung von Wissensverwaltungssystemen}
...
Seite \pageref{architektur.technologie} besprochen.
		...
		\decision{
			\decisionHeader{ARC-TIERS}{Tier Architektur}{Architektur}{Architektur design}
		}{
