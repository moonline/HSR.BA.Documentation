	...
	\subsection{Client}
		...
		\subsubsection{Architektur-Framework}
			\decision{
				...
				{Angular JS ist ein bekanntes MVW- und Templating Framework, erlaubt eine saubere Trennung von Logik und Darstellung und bindet ViewModel-Eigenschaften und -Funktionen ans Template. Dadurch lassen sich Observerkonstrukte sparen.
