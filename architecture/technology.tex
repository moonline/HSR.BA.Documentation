\section{Technologie}\label{architektur.technologie}
	...
	\subsection{Client}
		...
		Mit der Wahl der Sprache, stellt sich noch die Frage des Frameworks.
		Dessen Wahl ist nachfolgend beschrieben.
			...
			\decision{
				...
				{keine Speziellen}
				{Die Serverkomponente muss eine Schnittstelle bieten, über welche die Clientapplikation Daten austauschen kann.}
				{keine}
			}
