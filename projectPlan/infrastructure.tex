	...
	\section{Tools}
		...
		\subsection{Building \& Testing}
			...
			\subsubsection{Testkonzept}
				...
				\begin{description}
					\item[Logiktests] Unittests, die eine einzelne Klasse, 
					...
					\item[Integrationtests] Tests, die das Zusammenspiel zwischen Klassen, 
						Komponenten und Services testen. 
						Diese Tests können über mehrere Layers bis mehrere Tiers laufen.
					\item[Seleniumtests] Gross-Integrationstests, 
						...
						Dazu wird ein Browser gestartet und dessen Ausgabe analysiert.
				\end{description}
