	...
	\section{Tools}
		...
		\subsection{Versionsverwaltung}
			...
			\subsubsection{Git Flow}
				Git Flow\cite{driessen_git_2014} automatisiert häufige genutzte Git Operationen für einen Entwicklungsorkflow\cite{driessen_successful_2010} mit Master-, Develop-, und Featurebranches.
				Beispiel: Das Releasen einer neuen Version inklusive Branching, Merging und Tagging.
				
				
		\subsection{Literaturverwaltung}
			Zur Verwaltung von Literatur hat sich das Team für "`Zotero"'\cite{roy_rosenzweig_center_for_history_and_new_media_zotero_2014} entschieden.
			Zotero ist den Studenten dem Team seit der Einführung in Literaturrecherchen Anfang Studium bekannt und
		...
		\subsection{Development Environment}
			...
			für die Entwicklung mit Vagrant\cite{hashicorp_vagrant_2013} virtuelle Wegwerfumgebungen aufgebaut.
