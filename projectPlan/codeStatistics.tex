\section{Metriken}
	...
	Dies sind primär Getter und Setter.
	...
	Die Spitzen bei der Eins repräsentieren auch hier die Getter und Setter.
	...
	\subsection{Fazit}
		...
		In Abbildung\ \ref{fig:halsteadBugsPerMethod} ist diese Komplexitätsgrösse mit zwei der durch \eeppi\ eingesetzten Frameworks verglichen.
		...
		Es wird jedoch hier nicht die totale Grösse verglichen, sondern lediglich pro Methode.
		Diese Vermutung trifft deshalb nicht zu.
				
	\subsubsection{Typescript}
	%TODO Tobi: Die Zahlen sehen jetzt doch für den Client besser aus. Wollen wir den Abschnitt neu schreiben oder entfernen?
